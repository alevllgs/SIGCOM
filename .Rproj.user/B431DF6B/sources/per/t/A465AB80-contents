...
#en esta parte mejora el prorrateo del pabellon ya que solo odonto usa materiales de odontologia
ODOURG <- GG1 %>% filter(Cuenta=="15-MATERIAL DE ODONTOLOGÍA") %>% 
 mutate(`Centro de Costo`= case_when(
   `Centro de Costo` ==	"464-QUIRÓFANOS CARDIOVASCULAR"	~	"471-QUIRÓFANOS MAYOR AMBULATORIA",
   `Centro de Costo` ==	"467-QUIRÓFANOS DIGESTIVA"	~	"471-QUIRÓFANOS MAYOR AMBULATORIA",
   `Centro de Costo` ==	"475-QUIRÓFANOS NEUROCIRUGÍA"	~	"357-EMERGENCIAS ODONTOLOGICAS",
   `Centro de Costo` ==	"485-QUIRÓFANOS TRAUMATOLOGÍA Y ORTOPEDIA"	~	"471-QUIRÓFANOS MAYOR AMBULATORIA",
   `Centro de Costo` ==	"486-QUIRÓFANOS UROLOGÍA"	~	"471-QUIRÓFANOS MAYOR AMBULATORIA",
   `Centro de Costo` ==	"493-QUIRÓFANOS CIRUGÍA PLÁSTICA"	~	"471-QUIRÓFANOS MAYOR AMBULATORIA",
   `Centro de Costo` ==	"495-QUIRÓFANOS CIRUGÍA VASCULAR"	~	"471-QUIRÓFANOS MAYOR AMBULATORIA",
